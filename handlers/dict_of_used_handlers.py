...
handlers_BOT_parse_dict = {
    ...
    'BOT_handler_button_add_tickers_input': h_bot.BOT_handler_button_add_tickers_input,
    'BOT_handler_add_confirm_yes_and_finish': h_bot.BOT_handler_add_confirm_yes_and_finish,
